...
public class MainActivity extends AppCompatActivity implements CheckListener {
    ...
    private void initView() {
        ...
        wrapLayout = (WrapLayout) findViewById(R.id.wraplayout);
        wrapLayout.setOnSwapListener(new WrapLayout.OnSwapListener() {
            @Override
            public void onSwap(float offset) {
                rvSort.setAlpha(offset);
                mSortDetailFragment.redrawheader(1.0f - offset);
            }
        });
    }
